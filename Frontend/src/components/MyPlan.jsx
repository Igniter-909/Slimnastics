...
function MyPlan() {
  ...
  return (
    <div className='p-4 w-full flex flex-col h-full rounded-xl border-2 border-white/50'>
      <h1 className='text-2xl md:text-3xl font-vazirmatn font-bold text-start mb-6'>My Plans</h1>
      <div className='space-y-6'>
        {plans.map((plan) => (
          <div key={plan.planId?._id || plan._id} className='w-full rounded-xl border-2 border-white/50 p-4 md:p-6'>
            ...
            <p className='text-sm font-nunito text-white/30 mb-4'>
