    ...
    <div className='flex flex-col md:flex-row gap-6 p-4'>
      <div className='w-full md:w-1/3 p-6 flex flex-col rounded-xl border-2 border-red-500/40'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button type="submit" className='w-full bg-transparent text-white border-2 border-[#d90a14] p-2 rounded-md bg-[#d90a14] hover:bg-[#fe0fa7] transition-colors duration-300'>Add Progress</button>
        </form>
      </div>
